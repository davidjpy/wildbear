    ...
    return (
        <section className='imageboard'>
            <div className='imageboard__wrapper'>
                <img src='/assets/images/about.jpg' alt='about' className='imageboard__image' loading='lazy' />
            ...
            <div className='imageboard__wrapper'>
                <img src='/assets/images/gears.jpg' alt='gears' className='imageboard__image' loading='lazy' />
